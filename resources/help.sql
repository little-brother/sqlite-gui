...
('octet_length', 'function', 'octet_length (str)', 'Returns the number of bytes in the encoding of text string str', 'select octet_length(''привет''); --> 12', '', null, 1),
...
('timediff', 'function', 'timediff (A, B)', 'Returns the string that describe the amount of time that must be added to B in order to reach time A. The result format is YYYY-MM-DD HH:MM:SS.SSS', 'select timediff(''2023-02-15'',''2023-03-15''); --> -0000-01-00 00:00:00.000', '', '', 2),
