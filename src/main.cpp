...
HMENU hMainMenu, hDbMenu, hEditorMenu, hResultMenu, hTabResultMenu, hBlobMenu, hCliMenu;
	...
	switch (msg) {
		case WM_CLOSE: {
			...
			if (prefs::get("maximized")) {
				...
				prefs::set("splitter-height", prefs::get("splitter-height") * (prefs::get("height") - 12)/(rc.bottom - rc.top));
			}
